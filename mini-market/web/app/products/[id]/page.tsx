            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="flex flex-col p-6 sm:p-8 lg:p-10">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="flex items-center gap-0.5" aria-label={`${product.rating.rate} de 5 estrellas`}>
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star
                        key={star}
                        className={`w-4 h-4 ${
                ...
                <div className="bg-gray-50 rounded-xl p-4 space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-[#00703C]/10 rounded-lg">
                      <Truck className="w-4 h-4 text-[#00703C]" aria-hidden="true" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-[#00703C]/10 rounded-lg">
                      <Shield className="w-4 h-4 text-[#00703C]" aria-hidden="true" />
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-gray-900">
                        Garantia de 1 ano
                  ...
                  <div className="flex items-center gap-3">
                    <div className="p-2 bg-[#00703C]/10 rounded-lg">
                      <RotateCcw className="w-4 h-4 text-[#00703C]" aria-hidden="true" />
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-gray-900">
                        Devolucion facil
